...
import { getVolunteersAPI, removeVolunteersAPI } from "../../services/allAPI";
...
export default function AdminVolunteers() {
   ...
   const getVolunteers = async () => {
     try {
       ...
       const result = await getVolunteersAPI(reqHeader)
       console.log(result);
   ...
   const deleteVolunteers = async (id) => {
     ...
     const result = await removeVolunteersAPI(id,reqHeader)
     console.log(result);
      ...
      <div className="ml-72 w-full">
        ...
        <header className="px-10 py-6 bg-[#0d3a33] border-b border-[#1dd3b0]/30">
          <h1 className="text-3xl font-bold">
            Manage <span className="text-[#1dd3b0]">Volunteers</span>
          </h1>
        </header>
        ...
        <div className="px-10 py-14">
          ...
          <div className="overflow-x-auto">
            <table
              className="w-full bg-[#0d3a33] rounded-3xl shadow-xl
                ...
                {volunteers.map((vol) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <button type="button" onClick={()=>deleteVolunteers(vol._id)}
